...
class FindPathWidget(QWidget):
    ...
    def __initUi(self, default_filename: str = ''):
        ...
        self.__pathFindBtn = QPushButton('Import Audio File')
    ...
    def __find(self):
        if self.isForDirectory():
            ...
            filename = QFileDialog.getOpenFileName(self, 'Import Audio File', '', str_exp_files_to_open)
            if filename[0]:
                filename = filename[0]
            else:
                return
...
class MainWindow(QMainWindow):
    ...
    def __initUi(self):
        ...
        self.__browser.setPlaceholderText('Result will be displayed here')
